...
function [sens, y, sol] = senseq(adjpars,data)

[sol,y] = model_sol_LSA(adjpars,data);

%Depending on form of y, the sensitivity matrix could be dymodel/dpars or 
%dr/dpars where r = ymodel - ydata

[sens] = diffjac(adjpars,@myfun,y,data);


function y = myfun(adjpars,data)
 
[~,y] = model_sol_LSA(adjpars,data);
