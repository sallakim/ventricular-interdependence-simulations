function [outputs,rout,J] = model_sol_gammaopt(adjpars,data)


%{ 
    This function solves the ex vivo version of the model in end-diastole
    to determine the end-diastolic pressure-volume relationship from the
    model. 
    Inputs: 
